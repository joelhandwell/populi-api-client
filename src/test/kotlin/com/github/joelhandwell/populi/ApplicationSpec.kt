...
val personApplications = mutableListOf(
    Application(
        id = 54321,
        lead_id = 3214,
        person_id = 1234,
...
private val personApplicationResponse = ApplicationResponse(application =personApplications)

object ApplicationSpec : Spek({

    describe("Application") {

        it("marshal to xml") { assertMarshals(applicationResponse) }

        it("unmarshal from xml") { assertUnmarshals(applicationResponse, getApplicationsXml) }
    }

    describe("Application associated with a specific person") {

        it("marshal to xml") { assertMarshals(personApplicationResponse) }

        it("unmarshal from xml") { assertUnmarshals(personApplicationResponse, getPersonApplicationsXml) }
    }
})
...
const val getPersonApplicationsXml = """
<response> 
    <application> 
        <id>54321</id>
        <lead_id>3214</lead_id>
